    ...
    try:
        ...
        if ref_bytes:
            instruction = (
                ...
                f"2. Everything BELOW the top of the head is FROZEN — face, eyes, nose, mouth, "
                f"chin, cheeks, neck, beard, stubble, skin tone, expression, clothing, background — "
                f"must be pixel-perfect identical to IMAGE 1.\n"
